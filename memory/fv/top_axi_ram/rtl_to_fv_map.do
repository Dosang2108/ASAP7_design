...
# Generated on: Mon Apr 06 10:15:15 +07 2026 (Mon Apr 06 03:15:15 UTC 2026)
...
set logfile fv/top_axi_ram/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/top_axi_ram -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 rtl/axi_ctrl.v rtl/sram_macro.v rtl/top_axi_ram.v
elaborate_design -golden -root {top_axi_ram} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/top_axi_ram/fv_map.v.gz
elaborate_design -revised -root {top_axi_ram}
...
#add_name_alias fv/top_axi_ram/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.top_axi_ram.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.top_axi_ram.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.top_axi_ram.rtl.fv_map.rpt
